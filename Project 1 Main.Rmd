...
With this in mind, we thought it represented the perfect cross over between the two datasets. Both the payroll and the 311 dataset listed the community board that was responsible. We also wanted to see the distribution of 311 calls by community board! We think they would be relatively equal.
